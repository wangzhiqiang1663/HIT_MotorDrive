...
* Output         : None
* Return         : None
* 功能           ：根据ADC_InitStruct中指定的参数初始化外设ADCx的寄存器 ；
******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：把ADC_InitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：使能或者失能指定ADC在规则组转化后自动开始注入组转换 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：设置指定ADC的注入组通道，设置它们的转化顺序和采样时间 ；
*******************************************************************************/
...
* Output         : None
* Return         : None	  
* 功能           ：使能或者失能指定单个/全体，规则/注入组通道上的模拟看门狗 ；
*******************************************************************************/
