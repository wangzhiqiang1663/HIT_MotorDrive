...
* Output         : None
* Return         : None
* 功能           : 把EXTI_InitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* Description    : Clears the EXTI抯 line pending flags.
...
* Description    : Clears the EXTI抯 line pending bits.
