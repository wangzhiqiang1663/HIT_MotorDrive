...
* Output         : None
* Return         : None
* 功能           : 根据TIM1_TIM1BaseInitStruct中指定的参数初始化TIM1的时间基数单位 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 根据TIM1_OCInitStruct中指定的参数初始化TIM1通道1 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 根据TIM1_OCInitStruct中指定的参数初始化TIM1通道2 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 根据TIM1_OCInitStruct中指定的参数初始化TIM1通道3 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 根据TIM1_OCInitStruct中指定的参数初始化TIM1通道4 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 设置刹车特性，死区时间，锁电平，OSSI，OSSR状态和AOE（自动输出使能） ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 根据TIM1_ICInitStruct中指定的参数初始化外设TIM1 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 根据TIM1_ICInitStruct中指定的参数设置外设TIM1工作在PWM输入模式 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 把TIM1_OCInitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 把TIM1_ICInitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 把TIM1_TIM1BaseInitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           : 把TIM1_BDTRInitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* 功能           : 选择TIM1输出比较模式。
                   ...
                   用户必须使用函数TIM1_CCxCmd和TIM1_CCxNCmd来使能这个通道。
*******************************************************************************/
...
* Description    : Clears the TIM1抯 pending flags.
