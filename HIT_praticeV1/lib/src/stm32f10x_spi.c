...
* Output         : None
* Return         : None
* 功能           ：根据SPI_InitStruct中指定的参数初始化外设SPIx寄存器 ；
******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：把SPI_InitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
