...
* Output         : None
* Return         : None
* 功能           ：根据USART_InitStruct中指定的参数初始化外设USARTx寄存器 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：把USART_InitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
