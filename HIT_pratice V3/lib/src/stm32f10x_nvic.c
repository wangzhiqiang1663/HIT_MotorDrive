...
* Output         : None
* Return         : None
* 功能           : 把NVIC_InitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* 功能           : 返回当前活动的Handler（IRQ通道和系统Handler）的标识符 ；
*******************************************************************************/
...
* Output         : None
* Return         : CPU ID.
* 功能           : 返回ID号码，Cortex-M3内核的版本号和实现细节 ；
*******************************************************************************/
