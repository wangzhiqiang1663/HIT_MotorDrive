...
* Output         : None
* Return         : None
* 功能           ：根据TIM_TimeBaseInitStruct中指定的参数初始化TIMx的时间基数单位 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：根据TIM_OCInitStruct中指定的参数初始化外设TIM1 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：根据TIM_OCInitStruct中指定的参数初始化外设TIM2 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：根据TIM_OCInitStruct中指定的参数初始化外设TIM3 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：根据TIM_OCInitStruct中指定的参数初始化外设TIM4 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：根据TIM_ICInitStruct中指定的参数初始化外设TIMx ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：根据TIM_ICInitStruct中指定的参数设置外设TIM1工作在PWM输入模式
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：把TIM_TimeBaseInitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：把TIM_OCInitStruct中的每一个参数按缺省值填入
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：把TIM_ICInitStruct中的每一个参数按缺省值填入 
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：把TIM_BDTRInitStruct中的每一个参数按缺省值填入 ；
*******************************************************************************/
...
* Output         : None
* Return         : None
* 功能           ：选择TIMx输出比较模式。本函数在改变输出比较模式前失能选中的通道。
				   用户必须使用函数TIM_CCxCmd和TIM_CCxNCmd来使能这个通道。
*******************************************************************************/
