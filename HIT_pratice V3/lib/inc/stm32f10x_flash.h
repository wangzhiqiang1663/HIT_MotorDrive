...
/* Flash Latency -------------------------------------------------------------*/
#define FLASH_Latency_0                ((u32)0x00000000)  /* 0延时周期 */
#define FLASH_Latency_1                ((u32)0x00000001)  /* 1延时周期 */
#define FLASH_Latency_2                ((u32)0x00000002)  /* 2延时周期 */
...
#define FLASH_HalfCycleAccess_Enable   ((u32)0x00000008)  /* 半周期访问使能 */
#define FLASH_HalfCycleAccess_Disable  ((u32)0x00000000)  /* 半周期访问失能 */
...
#define FLASH_PrefetchBuffer_Enable    ((u32)0x00000010)  /* 预取指缓存使能 */
#define FLASH_PrefetchBuffer_Disable   ((u32)0x00000000)  /* 预取指缓存失能 */
...
#define FLASH_WRProt_Pages0to3         ((u32)0x00000001) /* 写保护页面0到3 */
#define FLASH_WRProt_Pages4to7         ((u32)0x00000002) /* 写保护页面 4 to 7 */
...
#define FLASH_WRProt_AllPages          ((u32)0xFFFFFFFF) /* 写保护全部页面 */
...
#define OB_IWDG_SW                     ((u16)0x0001)  /* 选择软件独立看门狗 */
#define OB_IWDG_HW                     ((u16)0x0000)  /* 选择硬件独立看门狗 */

#define IS_OB_IWDG_SOURCE(SOURCE) (((SOURCE) == OB_IWDG_SW) || ((SOURCE) == OB_IWDG_HW))

/* Option Bytes nRST_STOP ----------------------------------------------------*/
#define OB_STOP_NoRST                  ((u16)0x0002) /* 进入STOP模式不产生复位 */
#define OB_STOP_RST                    ((u16)0x0000) /* 进入STOP模式产生复位 */

#define IS_OB_STOP_SOURCE(SOURCE) (((SOURCE) == OB_STOP_NoRST) || ((SOURCE) == OB_STOP_RST))

/* Option Bytes nRST_STDBY ---------------------------------------------------*/
#define OB_STDBY_NoRST                 ((u16)0x0004) /* 进入Standby模式不产生复位 */
#define OB_STDBY_RST                   ((u16)0x0000) /* 进入Standby模式产生复位 */

#define IS_OB_STDBY_SOURCE(SOURCE) (((SOURCE) == OB_STDBY_NoRST) || ((SOURCE) == OB_STDBY_RST))

/* FLASH Interrupts ----------------------------------------------------------*/
#define FLASH_IT_ERROR                 ((u32)0x00000400)  /* FPEC错误中断源 */
#define FLASH_IT_EOP                   ((u32)0x00001000)  /* FLASH操作结束中断源 */

#define IS_FLASH_IT(IT) ((((IT) & (u32)0xFFFFEBFF) == 0x00000000) && (((IT) != 0x00000000)))

/* FLASH Flags ---------------------------------------------------------------*/
#define FLASH_FLAG_BSY                 ((u32)0x00000001)  /* FLASH忙标志位 */
#define FLASH_FLAG_EOP                 ((u32)0x00000020)  /* FLASH操作结束标志位 */
#define FLASH_FLAG_PGERR               ((u32)0x00000004)  /* FLASH编写错误标志位 */
#define FLASH_FLAG_WRPRTERR            ((u32)0x00000010)  /* FLASH页面写保护错误标志位 */
#define FLASH_FLAG_OPTERR              ((u32)0x00000001)  /* FLASH选择字节错误标志位 */
